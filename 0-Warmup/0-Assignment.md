...
3. Please provide a link to the repository you are using for this class.
    ...
    [CS283](https://github.com/CalebL605/CS283)

4. Briefly describe what you want to get out of this class.

    Since I am a Windows user, I don't interact with the Unix environment much, so I want to learn more about the Unix environment and become more comfortable working in it. My proficiency at using the C language isn't the best so I also want to get more comfortable with this language during this class. I haven't used Git in a while, so I am rusty with it and this class will be great to refresh my skills with it.

5. Briefly describe any concerns you might be having with being successful in this class (if any).

    I don't have any, I think I will do fine as long as I keep paying attention in class.